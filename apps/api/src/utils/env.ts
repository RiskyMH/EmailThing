...
const envSchema = z.object({
    ...
    EMAIL_SEND_URL: z.string().check(z.minLength(1)),
    EMAIL_SEND_URL_IMPORTANT: z.optional(z.string().check(z.minLength(1))),
...
const _env = envSchema.safeParse({
    ...
    EMAIL_SEND_URL_IMPORTANT: process.env.EMAIL_SEND_URL_IMPORTANT,
