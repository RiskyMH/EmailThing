...
export default function Home() {
    ...
    const currentMailbox = globalThis.window ? document.cookie.includes('mailboxId=') ? document.cookie.split('mailboxId=')[1].split(';')[0] : undefined : undefined
        ...
        <>
            <section className="flex flex-col gap-6 pt-6 pb-8 md:pt-10 md:pb-12 lg:py-32 sm:[.kawaii_&]:pt-10 lg:[.kawaii_&]:pb-10">
                <div className="container flex max-w-[64rem] flex-col items-center gap-4 text-center">
                    ...
                    <h1 className="block text-balance _font-bold !font-heading text-3xl sm:text-5xl md:text-6xl lg:text-7xl [.kawaii_&]:hidden">
            ...
            >
                <div className="mx-auto flex max-w-[58rem] flex-col items-center gap-4 text-center">
                    ...
                    <p className="max-w-[85%] text-muted-foreground leading-normal sm:text-lg sm:leading-7">
                        ...
                        make uses of the latest features of PWA's, Bun, React, and the web.
                    </p>
                </div>
