...
export const Sidebar = ({ className }: { className?: string }) => {
  ...
  return (
    <div
      className={cn(
        "flex min-h-screen flex-col overflow-y-auto text-sidebar-foreground sm:shrink-0 sm:p-2 pt-0! sm:max-lg:p-2 lg:w-60 sm:bg-sidebar 2xl:me-1",
        className,
      )}
    >
      <Button
  ...
  return (
    <>
      ...
      <DropdownMenu>
        ...
        >
          {mailboxId === "demo" ? (
            <UserCircle2 className="sm:max-lg:-me-1 lg:-ms-1 max-sm:-ms-1 max-sm:me-0.5 lg:me-0.5 size-6 text-yellow-500 sm:max-lg:ms-auto" />
          ) : (
            // null
