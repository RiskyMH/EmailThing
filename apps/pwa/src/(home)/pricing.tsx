...
export default function Pricing() {
  return (
    <section className="container flex flex-col gap-6 py-8 md:max-w-[64rem] md:py-12 lg:py-24">
      ...
      <div className="grid w-full items-start gap-10 rounded-lg bg-card dark:bg-card p-10 md:grid-cols-[1fr_200px]">
      ...
      <div className="mx-auto flex w-full max-w-[58rem] flex-col gap-4">
        <p className="max-w-[85%] text-muted-foreground leading-normal sm:leading-7">
          <strong>EmailThing is only a free app right now.</strong> If you would like to donate and
          keep the project free for everyone, you can do so on my{" "}
          <Link
