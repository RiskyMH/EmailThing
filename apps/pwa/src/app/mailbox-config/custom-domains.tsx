...
import { PlusIcon, MoreHorizontalIcon, Trash2Icon, ChevronLeftIcon, ChevronRightIcon, CopyIcon, Loader2, ClipboardIcon } from "lucide-react";
        ...
        <div className="max-w-[40rem]">
            <div className="flex pb-2">
                <h2 className="font-semibold text-lg">
                    Custom domains{" "}
                    <span className="text-muted-foreground text-sm">({customDomains?.length ?? 0}/3)</span>
                </h2>
                <SmartDrawer>
...
export function AddCustomDomainForm({
    mailboxId,
    initialDomain = "",
}: { mailboxId: string; initialDomain?: string }) {
    ...
    return (
        ...
        page === "form" ? (
            ...
            <>
                ...
                <div className="grid items-start gap-4 px-4 sm:px-0">
                    <Suspense fallback={<code className="font-mono h-52 overflow-auto rounded-md bg-[#17171e] p-2 text-sm w-full text-[#6A737D]">// Loading code...</code>}>
                        <CfWorkerCode />
                    </Suspense>
