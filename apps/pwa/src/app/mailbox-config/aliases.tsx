...
import { PlusIcon, CheckIcon, MoreHorizontalIcon, PencilIcon, Trash2Icon, Loader2 } from "lucide-react";
                        ...
                        {aliases?.length ? (
                            ...
                            <TableRow>
                                <TableCell className={`h-24 text-center ${!data ? "fade-in" : ""}`} colSpan={4}>
                                    {data ? "No aliases yet??" : <Loader2 className="size-8 animate-spin text-muted-foreground mx-auto" />}
                                </TableCell>
                            </TableRow>
                        )}
                    </TableBody>
