...
export const demoEmails: DBEmail[] = [
  ...
  },
  {
    ...
    html: makeHtml(
      "<p>You can now categorize your emails with custom labels and colors. Try it out and let us know what you think!</p>",
    ),
    size: 890,
    raw: "s3",
    replyTo: 0,
  ...
  },
  {
    ...
    categoryId: "2",
    html: makeHtml(
      "<p>It's been ages since we caught up. Are you free next Tuesday around 2pm?</p>",
    ),
    size: 678,
    raw: "s3",
    replyTo: 0,
  ...
  },
  {
    ...
    categoryId: "1",
    html: makeHtml(
      "<p>Action items:</p><ol><li>Update project timeline</li><li>Schedule client review</li><li>Prepare Q1 report</li></ol>",
    ),
    size: 890,
    raw: "s3",
    replyTo: 0,
