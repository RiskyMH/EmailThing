...
export const demoEmails: DBEmail[] = [
    ...
    },
    {
        ...
        isStarred: 0,
        isSender: 0,
        html: makeHtml("<p>If this wasn't you, please secure your account immediately.</p>"),
        size: 512,
        raw: "s3",
        replyTo: 0,
        givenId: 0,
    ...
    },
    {
        ...
        html: makeHtml("<p>You can now categorize your emails with custom labels and colors. Try it out and let us know what you think!</p>"),
        size: 890,
        raw: "s3",
        replyTo: 0,
        givenId: 0,
    ...
    },
    {
        ...
        isSender: 0,
        categoryId: "2",
        html: makeHtml("<p>It's been ages since we caught up. Are you free next Tuesday around 2pm?</p>"),
        size: 678,
        raw: "s3",
        replyTo: 0,
        givenId: 0,
    ...
    },
    {
        ...
        isStarred: 0,
        isSender: 0,
        html: makeHtml("<p>Your package was delivered at 2:30pm. How did we do?</p>"),
        size: 567,
        raw: "s3",
        replyTo: 0,
        givenId: 0,
    ...
    },
    {
        ...
        isStarred: 0,
        isSender: 0,
        html: makeHtml("<p>Get access to unlimited categories, advanced filters, and priority support with EmailThing Pro!</p>"),
        size: 789,
        raw: "s3",
        replyTo: 0,
        givenId: 0,
    ...
    },
    {
        ...
        isSender: 0,
        categoryId: "1",
        html: makeHtml("<p>Action items:</p><ol><li>Update project timeline</li><li>Schedule client review</li><li>Prepare Q1 report</li></ol>"),
        size: 890,
        raw: "s3",
        replyTo: 0,
        givenId: 0,
    ...
    },
    {
        ...
        isStarred: 1,
        isSender: 0,
        html: makeHtml("<p>RiskyMH starred your repo EmailThing</p>"),
        size: 456,
        raw: "s3",
        replyTo: 0,
        givenId: 0,
...
export const demoSentEmails: DBEmail[] = [
    {
        ...
        isSender: 1,
        categoryId: "2",
        html: makeHtml("<p>Here's the updated timeline as discussed in our meeting.</p>"),
        size: 768,
        raw: "s3",
        replyTo: 0,
        givenId: 0,
...
export const demoTempEmails: DBEmail[] = [
    {
        ...
        isSender: 0,
        tempId: "temp1",
        html: makeHtml("<p>Suspicious login attempt detected from unknown device.</p>"),
        size: 256,
        raw: "s3",
        replyTo: 0,
        givenId: 0,
...
export const demoDrafts: DBEmailDraft[] = [
    ...
    },
    {
        ...
        mailboxId: demoMailboxId,
        subject: "Draft email",
        body: "<p>This is a draft email</p>\n<p>Enjoy the markdowning!</p><!--tiptap-->",
        createdAt: new Date(),
        updatedAt: new Date(),
        to: [
            {
